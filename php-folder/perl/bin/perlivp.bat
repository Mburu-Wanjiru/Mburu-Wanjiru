...
#!perl
#line 29
    eval 'exec E:\brutal\xampp\htdocs\My-Projects\php-folder\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'E:\brutal\xampp\htdocs\My-Projects\php-folder\perl\bin\perl.exe';
