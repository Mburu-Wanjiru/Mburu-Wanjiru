...
FOR %%x IN ("E:\brutal\xampp\htdocs\My-Projects\php-folder\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\brutal\xampp\htdocs\My-Projects\php-folder\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\brutal\xampp\htdocs\My-Projects\php-folder\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\brutal\xampp\htdocs\My-Projects\php-folder\php\php.exe"
GOTO :INSTALLED
